...
//		medico.AddEsameEffettuato(effettuato);
		...
		Paziente paziente = accessPoint.creapaziente("CODICEFISCALE","Daniele","Rossi",null,"password");
		TipoEsame tipo=accessPoint.creaTipoesame("a", "b", 2, null);
		EsamePrenotato esame = accessPoint.CreaPrenotazione(paziente, tipo);
